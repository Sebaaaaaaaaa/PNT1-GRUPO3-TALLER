...
namespace Taller.Controllers
{
    public class NovedadesController : Controller
    {
        ...
        public NovedadesController(TallerDBContext context)
        {
            _context = context;
        }
        ...
        {
            ViewBag.Empleados = new SelectList(_context.Empleados.ToList(), "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,IdEmpleado,Patente,Estado")] Novedades novedades)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdEmpleado,Patente,Estado")] Novedades novedades)
        {
            if (id != novedades.Id)
            {
                return NotFound();
